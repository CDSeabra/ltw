<?php
	...
	//==========================================================================================
	$target_dir = "images/";
	$target_file = $target_dir . intval($last_id) . "-" . basename(strip_tags($_FILES["fileToUpload"]["name"]));
	$uploadOk = 1;
	...
	echo "id: " . $last_id;
	$stmt2->execute(array( intval($last_id), intval($last_id) . "-" . strip_tags($_FILES['fileToUpload']['name'])));
